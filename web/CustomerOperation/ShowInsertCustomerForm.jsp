<%-- 
    Document   : ShowInsertPersonForm
    Created on : 21.Mar.2014, 17:15:54
    Author     : Packard-Bell
--%>
...
<html>
    ...
    <body bgcolor="red">
        <form method="POST" action="CreateCustomer.jsp">
            ...
            <table style="margin-left"> 
                ...
                <tr>
                    ...
                    <td><input type="submit" value="Yeni Giriş" style="float:right;" /></td>
                </tr>
            </table>
        </form>
    </body>
